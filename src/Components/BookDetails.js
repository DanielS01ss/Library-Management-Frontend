...
const BookDetails = ()=>{
  ...
  <div>
   <button className="mx-10 my-7 text-xl border-2 border-black px-3 rounded-lg hover:bg-black hover:text-white py-2 font-bold "><FontAwesomeIcon icon={faAngleLeft} /> Back</button>
    ...
    <div className="py-5 w-[20%] mx-20 flex  justify-between">
        <button className="text-3xl hover:border-2 border-2 border-white hover:border-black px-4 py-2 hover:text-white hover:bg-black  hover:transition hover:ease-in rounded hover:duration-500">Borrow</button>
